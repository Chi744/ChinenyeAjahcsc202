...
import Component7 from './src/components/Component7/Component 7';
...
const AppStack = () => {
    ...
    <Stack.Screen name="Component6Screen" component={Component6} options={{title: 'Component 6', headerShown: false}}/>
