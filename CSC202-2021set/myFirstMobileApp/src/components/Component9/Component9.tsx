...
const Component9: React.FC = () => {
 ...
 setState({...state, museumItem:{...state.museumItem, dateCommissioned: dateCommissioned}, showDatePicker: Platform.OS === 'ios' ? true : 
false})//no need to hide if Platform is iOS
 }
